"""Generate the architecture SVG with the real SAN.png embedded as base64.

Run from repo root:  python tools\\gen_arch_svg.py
Outputs:             images/architecture.svg
"""
...
OUT = ROOT / "images" / "architecture.svg"
...
SVG = f"""<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 1720 1180\" font-family=\"'Segoe UI', system-ui, sans-serif\" role=\"img\" aria-label=\"Insurance AI Agents reference architecture\">
  ...
  <text x=\"96\" y=\"569\" font-size=\"12\" fill=\"#444\">▸ WebSocket streaming en vivo</text>
  ...
  <text x=\"840\" y=\"212\" font-size=\"11\" font-weight=\"700\" fill=\"#5C2D91\" letter-spacing=\"2.5\">MICROSOFT AGENT FRAMEWORK 1.4 · SEQUENTIAL GRAPH</text>
  ...
  <text x=\"932\" y=\"419\" font-size=\"11.5\" fill=\"#5A5A5A\">Extrae datos del parte de siniestro</text>
  ...
  <text x=\"932\" y=\"564\" font-size=\"11.5\" fill=\"#5A5A5A\">Risk score 0-100 + detección de fraude</text>
  ...
  <text x=\"932\" y=\"709\" font-size=\"11.5\" fill=\"#5A5A5A\">Reglas regulatorias + injection guard</text>
  ...
  <text x=\"500\" y=\"940\" font-size=\"10.5\" fill=\"#444\">claims · trazas · governance log</text>
  ...
  <text x=\"836\" y=\"910\" font-size=\"11\" fill=\"#5A5A5A\">Evidence (PDFs · fotos)</text>
