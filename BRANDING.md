...
export const BRAND: BrandConfig = {
  ...
  logoUrl: publicAsset('brand-logo.png'),  // Header / hero / autoplay logo
...
`brand-logo.png`, and update `BRAND.logoUrl` in `brand.ts` through the
`publicAsset` helper so nested deployments such as GitHub Pages keep working.
